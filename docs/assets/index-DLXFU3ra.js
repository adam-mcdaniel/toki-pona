...
async function Lv(l3) {
  ...
  l3 !== void 0 && (Object.getPrototypeOf(l3) === Object.prototype ? { module_or_path: l3 } = l3 : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), l3 === void 0 && (l3 = new URL("" + new URL("toki_pona_wasm_bg-CKvrHWTA.wasm", import.meta.url).href, import.meta.url));
  const i = Hv();
